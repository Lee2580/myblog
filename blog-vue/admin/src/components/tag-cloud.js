...
!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      e.a = {
        ...
        methods: {
            ...
            for (let e = 0, n = this.data.length; e < n; e++) {
              ...
              this.option.color
                ...
                : (this.$refs.tag[e].style.color =
                    ...
                    Math.round(255 * Math.random()) +
                    ")");
              let u = { x: i, y: a, z: s, ele: this.$refs.tag[e] };
              this.tagList.push(u);
            }
            let f = this;
          ...
          rotateX: function(t) {
            let e = Math.cos(this.rotateAngleX),
          ...
          rotateY: function(t) {
            let e = Math.cos(this.rotateAngleY),
    ...
    function(t, e, n) {
      function o(t) {
        for (let e = 0; e < t.length; e++) {
          ...
          if (o) {
            o.refs++;
            let r = 0;
            for (r = 0; r < o.parts.length; r++) o.parts[r](n.parts[r]);
            for (; r < n.parts.length; r++) o.parts.push(i(n.parts[r]));
            o.parts.length > n.parts.length &&
              (o.parts.length = n.parts.length);
          } else {
            for (let a = [], r = 0; r < n.parts.length; r++)
              a.push(i(n.parts[r]));
      ...
      let u = "undefined" != typeof document;
    ...
    function(t, e) {
      t.exports = function(t, e, n, o, r, i) {
        ...
        let f = "function" == typeof s ? s.options : s;
        e &&
          ((f.render = e.render),
