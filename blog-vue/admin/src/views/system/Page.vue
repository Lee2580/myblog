...
export default {
  ...
  methods: {
    ...
    listPages() {
      this.axios.get("/api/admin/listPages").then(({ data }) => {
    ...
    addOrEditPage() {
      ...
      this.axios.post("/api/admin/saveOrUpdatePage", this.pageForum).then(({ data }) => {
        if (data.status) {
          this.$notify.success({
            title: "成功",
    ...
    deletePage() {
      this.axios
        .delete("/api/admin/deletePage/" + this.pageForum.id)
        .then(({ data }) => {
          if (data.status) {
            this.$notify.success({
              title: "成功",
