  ...
  <div>
    ...
    <div class="home-banner" :style="cover">
      <div class="banner-container">
        <!-- 联系方式 -->
        <h1 class="website-title animated zoomIn">
        ...
        <div class="website-contact">
          <v-tooltip bottom>
            ...
            <span>{{blogInfo.websiteConfig.qq}}</span>
          </v-tooltip>
          <a
    ...
    <v-row class="home-container">
      <v-col md="9" cols="12">
        <v-card
          class="animated zoomIn blog-card"
      ...
      <v-col md="3" cols="12" class="d-md-block d-none">
        <div class="website-wrapper">
          <v-card class="animated zoomIn website-card mt-5">
          ...
          <!-- 网站信息 -->
          <v-card class="website-card animated zoomIn mt-5 big">
          ...
          <!-- 网站信息 -->
          <v-card class="website-card animated zoomIn mt-5">
            <div class="web-info-title">
  ...
  computed: {
    isRight() {
      return function(index) {
        if (index % 2 == 0) {
          return "blog-cover left-radius";
        }
        return "blog-cover right-radius";
      };
    },
    blogInfo() {
